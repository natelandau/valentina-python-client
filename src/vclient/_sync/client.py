...
class SyncVClient:
    ...
    for use with factory functions like `sync_companies_service()`.
    ...
    @property
    def companies(self) -> "SyncCompaniesService":
        """Access the Companies service for managing companies.

        Returns:
            The SyncCompaniesService instance for company operations.
        """
    ...
    @property
    def developer(self) -> "SyncDeveloperService":
        ...
        Returns:
            The SyncDeveloperService instance for self-service operations.
        """
    ...
    @property
    def global_admin(self) -> "SyncGlobalAdminService":
        ...
        Returns:
            The SyncGlobalAdminService instance for developer management operations.
        """
    ...
    @property
    def system(self) -> "SyncSystemService":
        """Access the System service for system-level operations.

        Returns:
            The SyncSystemService instance for system operations like health checks.
        """
    ...
    def users(self, company_id: str | None=None) -> "SyncUsersService":
        ...
        Returns:
            A SyncUsersService instance scoped to the specified company.
