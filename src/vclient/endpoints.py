...
class Endpoints:
    ...
    BLUEPRINT_CATEGORY_SUBCATEGORIES = f"{BLUEPRINT_CATEGORY_DETAIL}/subcategories"
    BLUEPRINT_CATEGORY_SUBCATEGORY_DETAIL = f"{BLUEPRINT_CATEGORY_SUBCATEGORIES}/{{subcategory_id}}"
    BLUEPRINT_SUBCATEGORY_TRAITS = f"{BLUEPRINT_CATEGORY_SUBCATEGORY_DETAIL}/traits"
