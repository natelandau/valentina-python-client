...
class TestChaptersServiceGetPage:
    ...
    async def test_get_page_chapters(self, vclient, base_url, paginated_chapters_response):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).get_page()
...
class TestChaptersServiceListAll:
    ...
    async def test_list_all_chapters(self, vclient, base_url, chapter_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).list_all()
...
class TestChaptersServiceIterAll:
    ...
    async def test_iter_all_chapters(self, vclient, base_url, chapter_response_data):
        ...
        chapters = [
            c
            async for c in vclient.chapters(company_id, user_id, campaign_id, book_id).iter_all(
                limit=1
            )
        ]
...
class TestChaptersServiceGet:
    ...
    async def test_get_chapter(self, vclient, base_url, chapter_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).get(chapter_id)
    ...
    async def test_get_chapter_not_found(self, vclient, base_url):
        ...
        with pytest.raises(NotFoundError):
            await vclient.chapters(company_id, user_id, campaign_id, book_id).get(chapter_id)
...
class TestChaptersServiceCreate:
    ...
    async def test_create_chapter_minimal(self, vclient, base_url, chapter_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).create(
            name="Test Chapter"
        )
...
class TestChaptersServiceUpdate:
    ...
    async def test_update_chapter_name(self, vclient, base_url, chapter_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).update(
    ...
    async def test_update_chapter_not_found(self, vclient, base_url):
        ...
        with pytest.raises(NotFoundError):
            await vclient.chapters(company_id, user_id, campaign_id, book_id).update(
...
class TestChaptersServiceDelete:
    ...
    async def test_delete_chapter(self, vclient, base_url):
        ...
        await vclient.chapters(company_id, user_id, campaign_id, book_id).delete(chapter_id)
...
class TestChaptersServiceRenumber:
    ...
    async def test_renumber_chapter(self, vclient, base_url, chapter_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).renumber(
            chapter_id, number=3
        )
...
class TestChaptersServiceNotes:
    ...
    async def test_get_notes_page(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).get_notes_page(
            chapter_id
        )
    ...
    async def test_list_all_notes(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).list_all_notes(
            chapter_id
        )
    ...
    async def test_get_note(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).get_note(
            chapter_id, note_id
        )
    ...
    async def test_create_note(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).create_note(
    ...
    async def test_update_note(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).update_note(
    ...
    async def test_delete_note(self, vclient, base_url):
        ...
        await vclient.chapters(company_id, user_id, campaign_id, book_id).delete_note(
            chapter_id, note_id
        )
...
class TestChaptersServiceAssets:
    ...
    async def test_list_assets(self, vclient, base_url, asset_response_data):
        ...
        # When: Listing assets
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).list_assets(
            chapter_id
        )
    ...
    async def test_get_asset(self, vclient, base_url, asset_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).get_asset(
            chapter_id, asset_id
        )
    ...
    async def test_delete_asset(self, vclient, base_url):
        ...
        await vclient.chapters(company_id, user_id, campaign_id, book_id).delete_asset(
            chapter_id, asset_id
        )
    ...
    async def test_upload_asset(self, vclient, base_url, asset_response_data):
        ...
        result = await vclient.chapters(company_id, user_id, campaign_id, book_id).upload_asset(
            chapter_id,
            filename="test.png",
