...
from vclient.models import Asset, Campaign, Note, PaginatedResponse, RollStatistics
...
def asset_response_data(asset_response_data_factory) -> dict:
    """Return sample asset response data for a campaign."""
...
class TestCampaignsServiceGetPage:
    ...
    async def test_get_page_campaigns(self, vclient, base_url, paginated_campaigns_response):
        ...
        result = await vclient.campaigns(company_id=company_id).get_page()
    ...
    async def test_get_page_with_pagination(self, vclient, base_url, campaign_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).get_page(limit=25, offset=50)
...
class TestCampaignsServiceListAll:
    ...
    async def test_list_all_campaigns(self, vclient, base_url, campaign_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).list_all()
...
class TestCampaignsServiceIterAll:
    ...
    async def test_iter_all_campaigns(self, vclient, base_url, campaign_response_data):
        ...
        campaigns = [c async for c in vclient.campaigns(company_id=company_id).iter_all(limit=1)]
...
class TestCampaignsServiceGet:
    ...
    async def test_get_campaign(self, vclient, base_url, campaign_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).get(campaign_id)
    ...
    async def test_get_campaign_not_found(self, vclient, base_url):
        ...
        with pytest.raises(NotFoundError):
            await vclient.campaigns(company_id=company_id).get(campaign_id)
...
class TestCampaignsServiceCreate:
    ...
    async def test_create_campaign_minimal(self, vclient, base_url, campaign_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).create(name="Test Campaign")
    ...
    async def test_create_campaign_with_all_fields(self, vclient, base_url, campaign_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).create(
            name="Test Campaign",
            description="A test campaign description",
            desperation=2,
            danger=3,
    ...
    async def test_create_campaign_validation_error(self, vclient):
        ...
        with pytest.raises(RequestValidationError):
            await vclient.campaigns(company_id="company123").create(name="AB")
...
class TestCampaignsServiceUpdate:
    ...
    async def test_update_campaign_name(self, vclient, base_url, campaign_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).update(
    ...
    async def test_update_campaign_not_found(self, vclient, base_url):
        ...
        with pytest.raises(NotFoundError):
            await vclient.campaigns(company_id=company_id).update(campaign_id, name="New Name")
...
class TestCampaignsServiceDelete:
    ...
    async def test_delete_campaign(self, vclient, base_url):
        ...
        await vclient.campaigns(company_id=company_id).delete(campaign_id)
...
class TestCampaignsServiceGetStatistics:
    ...
    async def test_get_statistics(self, vclient, base_url, statistics_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).get_statistics(campaign_id)
...
class TestCampaignsServiceAssets:
    ...
    async def test_get_assets_page(self, vclient, base_url, asset_response_data):
        """Verify getting a page of campaign assets."""
        ...
        result = await vclient.campaigns(company_id=company_id).get_assets_page(campaign_id)
    ...
    async def test_list_all_assets(self, vclient, base_url, asset_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).list_all_assets(campaign_id)
    ...
    async def test_get_asset(self, vclient, base_url, asset_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).get_asset(campaign_id, asset_id)
    ...
    async def test_delete_asset(self, vclient, base_url):
        ...
        await vclient.campaigns(company_id=company_id).delete_asset(campaign_id, asset_id)
    ...
    async def test_upload_asset(self, vclient, base_url, asset_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).upload_asset(
            campaign_id,
            filename="test.png",
...
class TestCampaignsServiceNotes:
    ...
    async def test_get_notes_page(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).get_notes_page(campaign_id)
    ...
    async def test_get_note(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).get_note(campaign_id, note_id)
    ...
    async def test_create_note(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).create_note(
    ...
    async def test_update_note(self, vclient, base_url, note_response_data):
        ...
        result = await vclient.campaigns(company_id=company_id).update_note(
    ...
    async def test_delete_note(self, vclient, base_url):
        ...
        await vclient.campaigns(company_id=company_id).delete_note(campaign_id, note_id)
